 ...
 * @Description: 
 * @Autor: Zhongyu
 * @Date: 2021-02-04 14:37:43
 * @LastEditors: Zhongyu
 * @LastEditTime: 2021-08-11 14:25:04
-->
<template>
	<div id="flow-draw" class="flow-draw">
		...
		<el-row>
			...
			<el-col :span="15" class="el-col-middle" style="background-color: #ffffff;">
...
import DrawItem from '../../../components/Draw/DrawItem';
import DrawDetail from '../../../components/Draw/DrawDetail';
		...
		init() {
			...
			this.jsPlumb.ready(function() {
				...
				_this.jsPlumb.bind('connection', function(evt) {
					...
					let fromAnchor = [evt.sourceEndpoint.anchor.x, evt.sourceEndpoint.anchor.y];
					let toAnchor = [evt.targetEndpoint.anchor.x, evt.targetEndpoint.anchor.y];
